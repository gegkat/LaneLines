...
def do_stuff():
  ...
  # dir = 70 75 gets left lane
  # sx 25 40 
  # sy 20 100
  # s thresh 20 100
  sx_binary, sy_binary, dir_binary, s_binary = thresh(undist, sx_thresh=(10,255), sy_thresh=(10,255), dir_thresh=(40, 180), s_thresh=(100,255))
  combined_binary, color_binary = combine_thresh(sx_binary, sy_binary, dir_binary, s_binary)



  if do_plot_binary:
    plot_binary(undist, combined_binary, color_binary)

  # For source points I'm grabbing the outer four detected corners
#  src = np.float32([(560, 360), (720, 360), (880, 720), (300, 720), ])
#  src = np.float32([(600, 450), (680, 450), (1080, 720), (230, 720), ])
#  src = np.float32([(0, 0), (1280, 0), (1280, 720), (0, 720), ])
 # src = np.float32([(580, 450), (700, 450), (1130, 720), (180, 720), ])
  src = np.float32([(595, 450), (680, 450), (1080, 720), (230, 720), ])

  offset = [400, 0] # offset for dst points

  M = warp(combined_binary, src, offset):
  ...
  return combined_binary, color_binary, dir_binary
